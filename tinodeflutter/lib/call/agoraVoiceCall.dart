...
class _State extends State<JoinChannelAudio> {
  ...
  String token =
      "007eJxTYFDpv9a5ZxGXiYbXLyeRv/ffHBC8vTdw4gqmS2lrL9qqh3coMKQapxgkpSWZJJqYpJiYGBkmmaeamZkmmaUZJ5taGCcmzbxZkdYQyMiwdvYaZkYGCATxORi8ElNSnTMSSxgYACqQImo=";
  bool isP2P = true;
  int? _remoteUid;
  late final RtcEngine _engine;
  String channelId = "JadeChat";
  ...
  Future<void> _initEngine() async {
    ...
    _rtcEngineEventHandler = RtcEngineEventHandler(
      ...
      onAudioRoutingChanged: (routing) {
        print('[onAudioRoutingChanged] routing: $routing');
      },
    );
